...
public class PathConfig {
    ...
    public static final String PYTHON_SCRIPTS_DIR = PROJECT_ROOT + File.separator + "python-scripts";
    ...
    public static String getValidStrategyPath(String nombreEntrada) throws Exception {
        ...
        if (fileInput.isAbsolute() || nombreEntrada.contains("/") || nombreEntrada.contains("\\") || nombreEntrada.contains("..")) {
